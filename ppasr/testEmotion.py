...
def testing(upload_path):
    ...
    model = joblib.load('E:\\zwork\\Models\\C_13_mfccNum_48.m')
    ...
    for wav_path in wav_paths:
        ...
        # print(model.predict_proba([data_feature])[0][0])

        labels = np.array(['angry', 'fear', 'happy', 'neutral', 'sad', 'surprise'])

        # print(model.predict_proba([data_feature])[0], labels, 6)
